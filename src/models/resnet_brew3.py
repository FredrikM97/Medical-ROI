...
def resnet18_brew3(pretrained=False, progress=True, **kwargs):
...
def resnet34_brew3(pretrained=False, progress=True, **kwargs):
...
def resnet50_brew3(pretrained=False, progress=True, **kwargs):
