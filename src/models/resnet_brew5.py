...
def resnet18_brew5(pretrained=False, progress=True, **kwargs):
...
def resnet34_brew5(pretrained=False, progress=True, **kwargs):
...
def resnet50_brew5(pretrained=False, progress=True, **kwargs):
