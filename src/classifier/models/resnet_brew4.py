...
def resnet18_brew4(pretrained=False, progress=True, **kwargs):
...
def resnet34_brew4(pretrained=False, progress=True, **kwargs):
...
def resnet50_brew4(pretrained=False, progress=True, **kwargs):
