...
def resnet18_brew6(pretrained=False, progress=True, **kwargs):
...
def resnet34_brew6(pretrained=False, progress=True, **kwargs):
...
def resnet50_brew6(pretrained=False, progress=True, **kwargs):
