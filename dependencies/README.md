This folder contains two previous work to simplify the implementation. Due to no official repository was found the work was manually added to the project.
